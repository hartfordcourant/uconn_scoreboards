...
class UConnMenScoreboard{
	...
	private function buildScoreboard($data){
	    ...
	    $scoreboard .= "<div id='hed_dropdown'><h1>Up Next<a target='_parent' href='http://www.courant.com/hc-uconn-mens-basketball-schedule-results-htmlstory.html' class='view_more'>All Results &gt;</a></h1><select id='leagues'></select></div>";
